...
const CatCard : React.FC<CatCardProps> = ({...props}) => {
    ...
    <div className="card">
        ...
        <CatImage image={images[props.catObject.catIndex].image} 
                    altText={images[props.catObject.catIndex].altText} 
                    licenceType={images[props.catObject.catIndex].altText} 
                    licenceUrl={images[props.catObject.catIndex].licenceUrl} 
                    attributionName={images[props.catObject.catIndex].attributionName} 
                    attributionUrl={images[props.catObject.catIndex].attributionUrl}/>
    </div>
);
};
